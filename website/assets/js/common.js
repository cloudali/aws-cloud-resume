/* ------------------------------------------------
 ...
 Created for the Cloud Resume Challenge.
 Read more about it here: https://cloudresumechallenge.dev/
------------------------------------------------ */
...
$(document).ready(function() {
    ...
    .then(data => {
    //        document.getElementById('visitor').innerText = data
        const vcount = data.id
